...
| Campo | Valor |
|---|---|
| Repositorio | `python_inventory_service_project` |
...
Servico de estoque: disponibilidade, reservas e movimentacoes. Este documento descreve requisitos, arquitetura e criterios de aceite.
