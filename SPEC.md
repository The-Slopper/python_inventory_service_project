# Especificacao Tecnica — Python Inventory Service

| Field | Value |
|---|---|
| Repository | `python_inventory_service_project` |
...
Inventory service: availability, reservations, and movinents. This document describes requirements, architecture, and acceptance criteria.
